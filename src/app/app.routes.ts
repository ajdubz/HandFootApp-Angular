...
import { GetTeamComponent } from './team/get-team/get-team.component';
...
export const routes: Routes = [
    ...
    { path: 'team/:id', component: GetTeamComponent, data: { title: 'View Team' } },
    { path: 'add-team', component: AddTeamComponent, data: { title: 'Add Team' } },
